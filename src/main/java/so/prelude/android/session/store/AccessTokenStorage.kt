...
private const val PREFS_FILE = "so.prelude.session.access"
 ...
 * nonce in [so.prelude.android.session.dpop.DPoPNonceStore]; it
 ...
 * propagates as [SessionTokenStoreError.StorageFailure] — the cache
 ...
 */
internal class SharedPreferencesAccessTokenStorage(context: Context) : AccessTokenStorage {
