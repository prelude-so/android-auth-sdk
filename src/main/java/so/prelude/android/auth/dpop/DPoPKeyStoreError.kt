...
internal sealed class DPoPKeyStoreError(
     ...
     * reasoning as `PreludeAuthError.Timeout`).
     */
    internal class MalformedSignature : DPoPKeyStoreError("DPoP signature DER is malformed")
}
