...
class RequestStepUpAuthTest {
    @Test
    fun requestStepUp_postsScope_andOmitsDispatchIdWhenUnconfigured() =
        runBlocking {
            ...
            val body =
                fixture.http
                    .requestsFor("/v1/session/stepup/request")
                    .single()
                    .bodyAsJson()
    ...
    @Test
    fun requestStepUp_attachesDispatchId_whenSignalsDispatcherConfigured() =
        runBlocking {
            var dispatched = 0
            val fixture =
                Fixture.make(
    ...
    @Test
    fun requestStepUp_401_triggersRefresh_andRetriesWithFreshBearer() =
        runBlocking {
