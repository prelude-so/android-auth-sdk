...
class SubmitStepUpOTPTest {
    @Test
    fun submitStepUpOTP_blockedChallenge_throwsInvalidChallengeToken_withoutNetwork() =
        runBlocking {
    ...
    @Test
    fun submitStepUpOTP_badCheckCode_throwsInvalidOTPCode_andLeavesChallengeReusable() =
        runBlocking {
    ...
    @Test
    fun submitStepUpOTP_otpCheckMissingChallengeToken_surfacesStructuredError() =
        runBlocking {
