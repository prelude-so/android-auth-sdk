 ...
 * client and is covered by [PreludeAuthClient]'s own suite (this
...
class AutoRefreshInterceptorTest {
    ...
    @Test
    fun happyPath_attachesBearer_andReturnsResponseUntouched() =
        runTest {
    ...
    @Test
    fun on401_invalidatesCache_refreshes_retriesWithNewToken() =
        runTest {
    ...
    @Test
    fun on401_refreshFails_returnsOriginal401_withoutThrowing() =
        runTest {
    ...
    @Test
    fun on401_retrySend_throws_propagates() =
        runTest {
    ...
    @Test
    fun on401_refreshCancelled_cancelsCaller() =
        runTest {
    ...
    fun on401_overwritesPreExistingAuthorizationHeader() =
        runTest {
            ...
            val response =
                interceptor.intercept(request) { req ->
    ...
    @Test
    fun nonAuthFailure_status_passesThrough() =
        runTest {
    ...
    @Test
    fun successfulRefresh_returnsRetryResponse_notOriginal() =
        runTest {
