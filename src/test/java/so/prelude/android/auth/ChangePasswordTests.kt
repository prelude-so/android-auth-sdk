...
class ChangePasswordTests {
    ...
    @Test
    fun changePassword_success_invalidatesCache_andRefreshes() =
        runBlocking {
    ...
    @Test
    fun changePassword_postsPasswordInBody_withRedactedToString() =
        runBlocking {
    ...
    fun changePassword_insufficientScope_throwsStructured_andSkipsRefresh() =
        runBlocking {
            ...
            assertThrows(PreludeAuthError.InsufficientScope::class.java) {
                runBlocking {
                    fixture.client.changePassword(RedactedString("new-secret-password"))
                }
            }
    ...
    @Test
    fun changePassword_invalidPassword_throwsStructured() =
        runBlocking {
    ...
    @Test
    fun changePassword_serverError_propagates_andSkipsRefresh() =
        runBlocking {
    ...
    private fun okhttp3.Request.bodyAsJson(): JsonObject = Json.parseToJsonElement(bodyAsString()).jsonObject
    ...
    @Test
    fun changePassword_success_clearsActiveStepUp() =
        runBlocking {
