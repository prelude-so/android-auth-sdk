...
class OtpClientAuthHeadersTest {
    @Test
    fun startOTPLogin_isUnauthenticated_attachesNeitherDPoPNorBearer() =
        runBlocking {
    ...
    @Test
    fun resendOTP_isUnauthenticated_attachesNeitherDPoPNorBearer() =
        runBlocking {
            val fixture = Fixture.make()
            fixture.http.install(
    ...
    @Test
    fun checkOTP_otpCheckIsUnauthenticated_attachesNeitherDPoPNorBearer() =
        runBlocking {
            val fixture = Fixture.make()
     ...
     */
    @Test
    fun startOTPLogin_postRequestCarriesJsonContentType() =
        runBlocking {
            val fixture = Fixture.make()
            fixture.http.install(
                "/v1/session/otp",
    ...
    @Test
    fun checkOTP_finalizeLoginIsDPoPSigned_andAttachesNoBearer() =
        runBlocking {
            val fixture = Fixture.make()
            fixture.http.installAll(
                "/v1/session/otp/check" to OtpFixtures.checkOkResponse(),
