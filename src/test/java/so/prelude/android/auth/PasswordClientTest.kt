...
class PasswordClientTest {
    ...
    private fun loginOkResponse(challenge: String = "challenge-abc") = StubHttpSession.Canned.json("""{"challenge_token":"$challenge"}""")
    ...
    @Test
    fun loginWithPassword_happyPath_returnsUser_persistsRefresh_andCachesAccessToken() =
        runBlocking {
    ...
    @Test
    fun loginWithPassword_postsCredentials_andOmitsDispatchIdWhenUnconfigured() =
        runBlocking {
            val fixture = Fixture.make()
            fixture.http.installAll(
                "/v1/session/login/email/password" to loginOkResponse(),
    ...
    @Test
    fun loginWithPassword_attachesDispatchId_whenSignalsDispatcherIsConfigured() =
        runBlocking {
            var dispatched = 0
            val fixture =
                Fixture.make(
            ...
            val body =
                fixture.http
                    .requestsFor("/v1/session/login/email/password")
                    .single()
                    .bodyAsJson()
    ...
    fun loginWithPassword_invalidEmailShape_mapsBadRequest() {
        ...
        // which `PreludeAuthError.from` maps to `BadRequest`. Pin it
    ...
    fun loginWithPassword_invalidPassword_mapsStructured() {
        ...
        assertThrows(PreludeAuthError.InvalidPassword::class.java) {
            runBlocking {
                fixture.client.loginWithPassword(
    ...
    @Test
    fun loginWithPassword_finalizeWithoutRefreshHeader_doesNotPersistRefreshToken() =
        runBlocking {
    ...
    private fun okhttp3.Request.bodyAsJson() = Json.parseToJsonElement(bodyAsString()).jsonObject
}
