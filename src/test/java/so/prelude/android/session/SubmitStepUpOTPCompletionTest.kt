...
class SubmitStepUpOTPCompletionTest {
    ...
    @Test
    fun submitStepUpOTP_completed_replacesCachedAccessToken_withRefreshedToken() = runBlocking {
    ...
    @Test
    fun submitStepUpOTP_advancesToOTPStep_returnsNextChallenge_withoutAutoFiringDelivery() = runBlocking {
    ...
    @Test
    fun activeStepUp_lifecycle_setOnRequest_advancedOnSubmit_clearedOnCompletion() = runBlocking {
