...
class RequestStepUpTest {
    ...
    @Test
    fun requestStepUp_otpStep_returnsChallenge_andDoesNotFireOTPDelivery() = runBlocking {
    ...
    @Test
    fun requestStepUp_underReview_returnsReviewHandle_andDoesNotFireOTPDelivery() = runBlocking {
        ...
        val fixture = Fixture.make()
        fixture.prePopulateStepUp()
        val reviewToken = StepUpFixtures.makeChallengeToken(
            mapOf(
