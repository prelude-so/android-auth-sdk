...
class StepUpEdgeCasesTest {
    ...
    fun multipleSequentialStepUpFlows_useIndependentChallengeHandles() = runBlocking {
        ...
        val tokenA = StepUpFixtures.makeChallengeToken(
            mapOf(
        ...
        val tokenB = StepUpFixtures.makeChallengeToken(
            mapOf(
    ...
    @Test
    fun requestStepUp_neverAutoFires_OTP_regardlessOfStatusOrStep() = runBlocking {
        ...
        val fixture = Fixture.make()
        fixture.prePopulateStepUp()
        val reviewOtpToken = StepUpFixtures.makeChallengeToken(
            mapOf(
    ...
    @Test
    fun expiredChallenge_recoveredCleanly_byFreshRequestStepUp() = runBlocking {
        ...
        val fixture = Fixture.make()
        fixture.prePopulateStepUp()
        val expiredToken = StepUpFixtures.makeChallengeToken(
            mapOf(
